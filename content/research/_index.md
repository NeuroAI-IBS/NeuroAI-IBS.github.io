...
Our group is investigating how to incorporate neuro-glia interactions into neural circuit modeling and aiming to gain novel insights into the computational role of glial cells, which we are currently only beginning to understand. For example, our [recent study](https://doi.org/10.1101/2024.05.30.596563) showed that the source of tonic inhibition in the cerebellar granule cells shifts from synaptic spillover to tonic GABA released by the lamellar astrocytes during adolescence. By computational modeling, we found that this shift weakens synaptically mediated regulation of network activity while promoting independence in neuronal activity within the network. This network-level change explained animal movements shifting to a less stable but more flexible regime during maturation.
